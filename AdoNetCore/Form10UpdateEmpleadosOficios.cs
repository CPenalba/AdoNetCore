...
namespace AdoNetCore
{
    public partial class Form10UpdateEmpleadosOficios : Form
    {
        ...
        private void lblSumaSalarial_Click(object sender, EventArgs e)
        {

        }

        private void lblMediaSalarial_Click(object sender, EventArgs e)
        {

        }

        private void lblMaximoSalario_Click(object sender, EventArgs e)
        {
